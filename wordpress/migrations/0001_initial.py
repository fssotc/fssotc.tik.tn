# -*- coding: utf-8 -*-
# Generated by Django 1.11.4 on 2017-08-16 12:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('site_id', models.IntegerField(help_text='The site ID on Wordpress.com')),
                ('wp_id', models.IntegerField(help_text='The object ID on Wordpress.com')),
                ('url', models.CharField(help_text='The full URL to the media file', max_length=255)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.TextField(blank=True, null=True)),
                ('url', models.CharField(help_text='The full permalink URL to the post', max_length=255)),
                ('short_url', models.CharField(help_text='The wp.me short URL', max_length=255)),
