# -*- coding: utf-8 -*-
# Generated by Django 1.9.9 on 2016-10-21 11:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_name', models.CharField(default='iisharing.Item', help_text='Please specify the app_label.model_name', max_length=255)),
                ('field_list', models.CharField(blank=True, help_text='Enter list of fields in order only if\n                                     you dont have a header row with matching field names, eg.\n                                     "column1=shared_code,column2=org(Organisation|name)"', max_length=255)),
